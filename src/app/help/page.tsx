        ...
        <>
            ...
            <Section id="faq" className="section-container flex min-h-screen flex-col justify-center gap-8">
                <div className="text-center">
                    ...
                    <div className="mx-auto my-12 flex max-w-[1000px] flex-col gap-4">
                        <Accordion
                        ...
                        >
                            ...
                            <AccordionDetails className="content-body">
                                A text of around 300 characters, would typically cost ~12 tokens. This comes from the AI check, plagiarism check and
                                modification function. For 1000 tokens, this should last around 80 submissions.
                            </AccordionDetails>
                        </Accordion>
                        <Accordion
                            className="bento-card content-body p-2 text-start lg:p-4"
