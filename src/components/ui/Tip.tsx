...
export const Tip: React.FC<TipProps> = ({ className, size = 22, tooltip }) => {
    return (
        <CustomTooltip title={
            <div className='py-4 px-2'>
                <h4 className='content-subtitle text-xl mb-2'>{tooltip.title}</h4>
                <p className='content-body text-base mb-2'>{tooltip.desc}</p>
